    ...
    public class SubContentBuilder
    {
        ...
        public SubContentBuilder()
        {
            _subContent = new SubContent
            {
                ...
                TestTemplateConfigs = new List<TestTemplateConfig>()
            };
        }

        public static SubContentBuilder Create() => new SubContentBuilder();

        public SubContentBuilder WithSubContentId(Guid id)
        {
        ...
        public SubContentBuilder WithQuestions(ICollection<Question> questions)
        {
            _subContent.Questions = questions;
            return this;
        }

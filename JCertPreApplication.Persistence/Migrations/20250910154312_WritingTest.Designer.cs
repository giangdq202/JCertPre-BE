...
namespace JCertPreApplication.Persistence.Migrations
{
    ...
    [Migration("20250910154312_WritingTest")]
            ...
            modelBuilder.Entity("JCertPreApplication.Domain.Entities.Question", b =>
                {
                    ...
                    b.HasIndex("isActive", "SubContentId", "difficulty");
            ...
            modelBuilder.Entity("JCertPreApplication.Domain.Entities.StudentProfile", b =>
                {
                    ...
                    b.Property<DateTime?>("lastResetTestTime")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<int>("numberOfTestsTaken")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("JCertPreApplication.Domain.Entities.Test", b =>
                {
                    ...
                    b.HasIndex("TestTemplateTypeId", "status");
            ...
            modelBuilder.Entity("JCertPreApplication.Domain.Entities.TestTemplateType", b =>
                {
                    ...
                    b.HasOne("JCertPreApplication.Domain.Entities.User", "VerifiedByUser")
                        .WithMany()
